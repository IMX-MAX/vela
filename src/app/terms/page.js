  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#fdfdfc] text-[#1e1e1e] font-sans">
      ...
      <div className="max-w-3xl mx-auto w-full px-8 py-12">
        <h1 className="text-3xl font-bold mb-8">Terms of Service for Vela</h1>
        ...
        <div className="space-y-8 text-gray-800 leading-relaxed">
          ...
          <section>
            ...
            <p>Vela is an advanced, AI-powered email client built on top of the Gmail API. It allows users to read, organize, and send emails, and utilizes Mistral AI to provide summarization and automated drafting capabilities.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold mb-3">3. User Accounts & Responsibilities</h2>
            <p>To use Vela, you must sign in using your Google account. You are responsible for safeguarding the password and credentials that you use to access the service and for any activities or actions under your password. You agree not to disclose your password to any third party.</p>
