    ...
    <div className="flex h-screen items-center justify-center bg-[#eceae6]">
      <div className="w-full max-w-sm rounded-2xl border border-[#2b323b]/5 bg-[#eceae6] p-8 shadow-sm">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg bg-white border border-gray-200 px-4 py-2.5 text-sm font-medium text-gray-700 transition hover:bg-gray-50 shadow-sm"
        >
