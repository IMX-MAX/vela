...
export default function LoginPage() {
  ...
  return (
    <div className="flex h-screen items-center justify-center bg-[#f2f2f1]">
      <div className="w-full max-w-sm rounded-xl border border-black/5 bg-[#fdfdfc] p-8 shadow-sm">
        <div className="mb-6 flex flex-col items-center">
          <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-black text-white">
            <EnvelopeSimple size={24} weight="fill" />
          </div>
          <h1 className="text-xl font-medium text-gray-900">Welcome to Vela</h1>
